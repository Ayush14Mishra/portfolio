...
function Project() {
    ...
    <div className="projects-container" id="projects">
        ...
        <p className="section-intro">Original products and a credited learning project spanning agricultural technology, computer vision, hackathon workflow and education.</p>
        <div className="projects-grid">
            ...
            <article className="project"><div className="project-visual visual-four"><span>04 / COMPUTER VISION</span><strong>MOVE WITHOUT TOUCH</strong></div><div className="project-copy"><span>Python · OpenCV · MediaPipe · NumPy</span><h2>AirShift</h2><p>A gesture-controlled sliding puzzle that turns real-time hand tracking and pinch detection into natural game input, with three difficulty levels, move tracking and timed challenges.</p><div className="project-links"><a href="https://github.com/Ayush14Mishra/AirShift" target="_blank" rel="noreferrer">Source ↗</a></div></div></article>
        </div>
    </div>
    );
}
